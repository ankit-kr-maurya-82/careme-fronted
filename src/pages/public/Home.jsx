        ...
        <div className="hero-shell">
          <div className="hero-content">
            ...
            <p className="hero-sub">
              A hospital-grade platform where patients submit problems and
              doctors deliver medicines, tests, and diet guidance with clarity.
            </p>
            ...
            <div className="hero-actions">
              <button
                ...
                type="button"
                onClick={() => navigate(findDoctorPath)}
              >
                Book Appointment
              </button>
